import { getSelfPunchedTimes, getSelfPunchedRank, getSeflMaxLabels, getActPunchedTimes, getActUserGender, countActHeldDays, countActHeldNum, getActHotRankvsSelf,getActHotRankvsAll } from "../../async/async.js";
const app = getApp();
...
Page({
  ...
  async onReady() {
    ...
    const {maxLabels,labelNum} = await getSeflMaxLabels(openId);
    console.log("最多的标签：", maxLabels);
    this.setData({
      //分成三份
      maxLabels:maxLabels.slice(0,3),
    });
