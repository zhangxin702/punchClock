...
//因为他不是一个类，所以每次引用必须对该页所有值进行初始化
function reset(){
  chartOpt.chartPieCount=0,
  chartOpt.hideXYaxis= false,
  chartOpt.axisMark= [],
  chartOpt.barLength= 0,
  chartOpt.barNum= 0,
  // bgColor: "transparent",
  chartOpt.chartWidth= 0,
  chartOpt.chartHeight= 0,
  chartOpt.legendWidth= 0,
  chartOpt.legendHeight= 0,
  chartOpt.chartSpace= 10,
  chartOpt.textSpace= 5,
  chartOpt.top= 0,
  chartOpt.left= 0,
  chartOpt.right= 0,
  chartOpt.bottom= 0,
  chartOpt.axisLeft= 0,
  chartOpt.axisBottom= 0,
  chartOpt.axisTop= 0
}
...
function drawBarChart(ctx, i, series, barWidth, barHeight, maxMark) {
  ...
  // console.log("barNum",chartOpt.barNum);
